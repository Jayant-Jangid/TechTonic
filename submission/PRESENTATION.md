...
- **PPT:** `[Open Final Presentation](./Team_KisanSetu_SIH2026_Presentation.pptx)`

### Requirements

- Upload only the final presentation.
- Use a clear file name, for example `TeamName_SIH2026_Presentation.pptx`.
- If the presentation is too large for GitHub (>25MB), upload it to Google Drive/OneDrive and put the shareable viewer link below instead.
